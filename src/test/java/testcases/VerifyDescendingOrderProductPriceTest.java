...
public class VerifyDescendingOrderProductPriceTest extends TestBase {
	...
	public void verifyPriceTest() throws InterruptedException {
		...
		CoreFunctions.doSelectDropDownByVisibleText(homePage.getDropdown(), AppConstants.FILTER_HIGH_LOW);
		...
		Collections.reverse(beforeSortingPriceList);
